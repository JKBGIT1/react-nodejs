...
class ContextProvider extends React.Component {
    ...
    tryLogin = async (userName, password) => {
        try {
            const response = await fetch(`https://awesome-montalcini-905efd.netlify.app/login?userName=${userName}&password=${password}`);
    ...
    trySignUp = async (firstName, lastName, email, userName, password) => {
        try {
            ...
            const response = await fetch(`https://awesome-montalcini-905efd.netlify.app/signup`, requestOptions);
            const data = await response.json();
    ...
    addToFavorite = async () => {
        ...
        try {
            ...
            const response = await fetch("https://awesome-montalcini-905efd.netlify.app/myfavorite", requestOptions);
            const data = await response.json();
            this.setState({
                logedUser: data.user
            });
